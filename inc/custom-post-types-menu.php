...
function curry_leaves_co_short_description_meta_box($post)
{
    ...
    <textarea rows="2" cols="40" name="excerpt" id="excerpt" maxlength="500"
...
function curry_leaves_co_menu_meta_box_callback($post)
{
    ...
    <p>
        ...
        <input type="text" id="menu_item_price" name="menu_item_price" value="<?php echo esc_attr($price); ?>" size="25" />
    </p>
    <p>
        <label for="menu_item_discount"><strong><?php _e('Discount (%)', 'curry-leaves-co'); ?></strong></label><br>
    ...
    <p>
        ...
        <input type="text" id="menu_item_offer_amount"
            value="<?php echo esc_attr($offer_amount !== '' ? number_format_i18n(floatval($offer_amount), 2) : $calculated_offer_amount); ?>"
            size="25" readonly style="background:#f7f7f7;border:1px solid #ddd;" />
    </p>
    <p>
        <label for="menu_item_final_price"><strong><?php _e('Offer Price', 'curry-leaves-co'); ?></strong></label><br>
        <input type="text" id="menu_item_final_price" value="<?php echo esc_attr($calculated_final_price); ?>" size="25"
            readonly style="background:#f7f7f7;border:1px solid #ddd;" />
    </p>
    <script>
        (function () {
...
function curry_leaves_co_menu_category_add_form_fields()
{
    ...
    <div class="form-field">
        ...
        <p class="description">
            <?php _e('Enable this category to appear in the Favourite Dishes section on the homepage.', 'curry-leaves-co'); ?>
        </p>
    </div>
    <?php
}
...
function curry_leaves_co_menu_item_admin_script()
{
    ...
    <div class="clc-dom-modal-overlay" id="clc-dom-modal" role="dialog" aria-modal="true"
        aria-labelledby="clc-dom-modal-title">
        <div class="clc-dom-modal">
            <div class="clc-dom-modal__header">
                <p class="clc-dom-modal__title" id="clc-dom-modal-title">
                    <?php echo esc_html__('Save Dish of the Month?', 'curry-leaves-co'); ?>
                </p>
                <button type="button" class="clc-dom-modal__close" data-clc-dom-close
                    aria-label="<?php echo esc_attr__('Close', 'curry-leaves-co'); ?>">×</button>
            </div>
            <div class="clc-dom-modal__body">
                <p style="margin:0 0 10px 0;"><?php echo esc_html__('Selected Dish:', 'curry-leaves-co'); ?> <strong
                        id="clc-dom-selected-name"></strong></p>
                <p style="margin:0;">
                    <?php echo esc_html__('Click Save to update the dish of the month ', 'curry-leaves-co'); ?>
                </p>
            </div>
            <div class="clc-dom-modal__footer">
                <button type="button" class="button"
                    data-clc-dom-cancel><?php echo esc_html__('Cancel', 'curry-leaves-co'); ?></button>
                <button type="button" class="button button-primary"
                    data-clc-dom-save><?php echo esc_html__('Save', 'curry-leaves-co'); ?></button>
            </div>
        </div>
    </div>
